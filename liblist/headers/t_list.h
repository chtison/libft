...
struct				s_list_object
{
	...
	int			(*push_at_index)(t_list *, const void *,
					size_t);

	void			*(*peek_front)(const t_list *);
	void			*(*peek_back)(const t_list *);
	void			*(*peek_at_index)(const t_list *, size_t);

	void			*(*pop_front)(t_list *);
	void			*(*pop_back)(t_list *);
	void			*(*pop_at_index)(t_list *, size_t);

	void			(*map)(t_list *, void *,
					int (*)(const void **, void *, size_t));

	int			(*set)(t_list *, const char *, const void *);
	void			*(*get)(t_list *, const char *);
	void			*(*remove)(t_list *, const char *);
